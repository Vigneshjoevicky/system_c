...
instructions array_in[5]={ {"add",1,2},{"sub",3,2}, {"mul",5,2},{"mod",10,2},{"and",1,2}  };
...
/* implemented a 3-stage instruction pipeline in SystemC with fetch, decode, and execute stages.
Each stage is a separate SC_MODULE, and they communicate using sc_fifo channels.
The fetch stage reads predefined instructions, the decode stage forwards them, and the execute stage performs operations like add, sub, mul, mod, and and.
The system is synchronized using a clock signal, and each stage operates on the positive edge of the clock.*/
